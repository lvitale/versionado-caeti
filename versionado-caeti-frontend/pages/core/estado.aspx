<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="estado.aspx.cs" Inherits="versionado_caeti_frontend.pages.core.estado" MasterPageFile="~/pages/master-page/default.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" Runat="Server">
    ...
    <table align="center">
                <tr>
                    ...
                    <td><asp:TextBox ID="txtDescripcion" runat="server" CssClass="camposArea" Width="146px"/></td>
    ...
    <br />
    <asp:DataGrid ID="grillaEstado" runat="server" AllowPaging="True" 
        AllowSorting="True" 
        AutoGenerateColumns="False"
        Width="100%"  
        PageSize="10" 
        onselectedindexchanged="grillaEstado_SelectedIndexChanged">
